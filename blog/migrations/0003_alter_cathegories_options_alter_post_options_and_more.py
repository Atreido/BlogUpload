...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='post',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.cathegories', verbose_name='Категорія'),
        ),
        migrations.AlterField(
            model_name='post',
            name='poster',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('posted', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.post', verbose_name='Пост')),
